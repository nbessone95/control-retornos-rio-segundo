...
if menu == "Subir Plantillas":
    ...
    if not files:
        ...
        if st.session_state.selected_file:
            ...
            # HOJA 1 - Como en tu Excel original
            ...
            canvas = st_canvas(height=280, width=700, stroke_width=4, stroke_color="#000000", background_color="#ffffff", key="canvas")
            ...
            if st.button("💾 Guardar Control Completo", type="primary"):
                if canvas.image_data is not None:
                    ...
                    data = {
                        ...
                        "Despacho_2500": despacho_2500,
                        "Despacho_2000": despacho_2000,
                        "Despacho_1250": despacho_1250,
    ...
    if data_files:
        for file in sorted(data_files, reverse=True):
            ...
            st.dataframe(df.drop(columns=["Firma"]), use_container_width=True)
